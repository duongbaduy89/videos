...
export default function XBottomNav() {
  ...
  const handleSelectUploadType = (type) => {
    ...
    if (type === "photo") navigate("/createpost"); // component CreatePost
    else if (type === "video") navigate("/upload"); // component Upload
  };
      ...
      <nav className="x-bottom-nav" aria-label="Bottom navigation">
        <ul className="x-nav-list">
          ...
          <li className="x-nav-item">
            <button className="x-icon-btn" aria-label="Home" onClick={() => navigate("/")}>
              <svg viewBox="0 0 24 24" fill={isActive("/") ? "white" : "none"} stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="x-icon">
          ...
          <li className="x-nav-item" onClick={handleSearch}>
            <button className="x-icon-btn" aria-label="Search">
              <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="x-icon">
          ...
          <li className="x-nav-item x-center-item">
            <button className="x-plus-btn" aria-label="Upload" onClick={handleUpload}>
              <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="x-plus-icon">
          ...
          <li className="x-nav-item">
            <button className="x-icon-btn" aria-label="Notifications" onClick={() => navigate("/notifications")}>
          ...
          <li className="x-nav-item">
            <button className="x-icon-btn" aria-label="Messages" onClick={handleMessages}>
              ...
              {unreadMessages > 0 && <span className="x-badge-red">{unreadMessages}</span>}
            </button>
          </li>
