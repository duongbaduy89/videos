...
export default function TwitterVideoPlayer({ videoUrl, autoPlayEnabled, onUserPlay }) {
  ...
  // ==============================
  // AUTOPLAY CHO VIDEO SAU KHI ĐÃ UNLOCK
  // ==============================
  useEffect(() => {
  ...
  const togglePlay = () => {
    ...
    if (v.paused) {
      ...
      // 🔥 VIDEO ĐẦU TIÊN: khi user ấn play, unlock audio
